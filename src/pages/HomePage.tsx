// Homepage component with search and pagination functionality
...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:from-black dark:via-gray-900 dark:to-gray-800">
      {/* Background Pattern */}
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-black/40 backdrop-blur-md border-t border-gray-700/30 py-8">
