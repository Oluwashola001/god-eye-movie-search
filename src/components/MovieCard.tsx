// Movie card component with hover effects and detailed information
...
export const MovieCard: React.FC<MovieCardProps> = ({ movie, onClick }) => {
  ...
  return (
    <div 
      className="
        group relative bg-gray-900/40 dark:bg-gray-900/60 backdrop-blur-sm 
        rounded-xl overflow-hidden border border-gray-700/30 
    ...
    >
      ...
      <div className="relative aspect-[2/3] overflow-hidden bg-gray-800">
        ...
        ">
          <span className="text-xs text-amber-400 font-medium">{mediaType}</span>
        </div>
      </div>
